...
:------------------- | :------------ | ----------- | ------------------------------------------------------------------:
`.color-gray`        | Cinza         | #656565     | ![img](../../static/css/gray.png)
`.color-red`         | Vermelha      | #D71F3C     | ![img](../../static/css/red.png)
`.color-purple`      | Roxo          | #641E75     | ![img](../../static/css/purple.png)
`.color-aquamarine`  | Aquamarine    | #20BEC6     | ![img](../../static/css/aquamarine.png)
`.color-green`       | Verde         | #20C67B     | ![img](../../static/css/green.png)
`.color-yellow`      | Amarelo       | #F2B838     | ![img](../../static/css/yellow.png)

Além das classes para color, o Ugla oferece também classes para o atributo `background`:

Class                     | Cor           | Hexadecimal | Representação
:------------------------ | :------------ | ----------- | ------------------------------------------------------------------:
`.background-gray`        | Cinza         | #656565     | ![img](../../static/css/gray.png)
`.background-red`         | Vermelha      | #D71F3C     | ![img](../../static/css/red.png)
`.background-purple`      | Roxo          | #641E75     | ![img](../../static/css/purple.png)
`.background-aquamarine`  | Aquamarine    | #20BEC6     | ![img](../../static/css/aquamarine.png)
`.background-green`       | Verde         | #20C67B     | ![img](../../static/css/green.png)
`.background-yellow`      | Amarelo       | #F2B838     | ![img](../../static/css/yellow.png)
...
## Tabela de cores
![img](../../static/css/table-colors.png)
...
![img](../../static/css/table-others.png)
