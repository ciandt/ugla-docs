...
:--------------------------- | :------------ | ----------- | ------------------------------------------------------------------:
`.theme-colored-gray`        | Cinza         | #656565     | ![img](../../static/img/css/gray.png)
`.theme-colored-red`         | Vermelha      | #D71F3C     | ![img](../../static/img/css/red.png)
`.theme-colored-purple`      | Roxo          | #641E75     | ![img](../../static/img/css/purple.png)
`.theme-colored-aquamarine`  | Aquamarine    | #20BEC6     | ![img](../../static/img/css/aquamarine.png)
`.theme-colored-green`       | Verde         | #20C67B     | ![img](../../static/img/css/green.png)
`.theme-colored-yellow`      | Amarelo       | #F2B838     | ![img](../../static/img/css/yellow.png)
