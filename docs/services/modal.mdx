...
Começaremos com o com ponente, que é a base para o bom funcionamento:
...
![img](../../static/img/services/modal-error.png)
...
![img](../../static/img/services/modal-warning.png)
...
```
![img](../../static/img/services/modal-success.png)
...
```
![img](../../static/img/services/modal-info.png)