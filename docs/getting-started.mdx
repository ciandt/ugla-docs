...
### Protótipo
Todos seus componentes são planejados separadamente e adicionados a uma biblioteca de protótipo. Seus componentes são desenvolvidos no [**Figma**](https://www.figma.com/).
...
```typescript {4} title="path/src/app/app.module.ts"
imports: [
  BrowserModule,
  ...,
