...
:---------- | :-------------------------------------------- | ----------- | -----------:
GRAY        | Cinza                                         | #656565     | ![img](../../static/services/gray.png)
RED         | Vermelha                                      | #D71F3C     | ![img](../../static/services/red.png)
PURPLE      | Roxo                                          | #641E75     | ![img](../../static/services/purple.png)
AQUAMARINE  | Aquamarine                                    | #20BEC6     | ![img](../../static/services/aquamarine.png)
GREEN       | Verde                                         | #20C67B     | ![img](../../static/services/green.png)
YELLOW      | Amarelo                                       | #F2B838     | ![img](../../static/services/yellow.png)
WHITE       | Branco nos background e Aquamarine como focal | #FFFFFF     | ![img](../../static/services/white.png)
